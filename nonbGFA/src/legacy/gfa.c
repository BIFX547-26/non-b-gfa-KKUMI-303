...
int gfa_run_cli(int argc, char *argv[]) {
	...
	GFAOptions options;
	GFAFlags flags;
	gfa_init_default_options(&options);
	gfa_init_default_flags(&flags);
	...
	void getGislands(int minGQrep, int total_bases);
...
#define minGQrep options.minGQrep
#define maxGQspacer options.maxGQspacer
#define minMRrep options.minMRrep
#define maxMRspacer options.maxMRspacer
#define minIRrep options.minIRrep
#define maxIRspacer options.maxIRspacer
#define shortIRcut options.shortIRcut
#define shortIRspacer options.shortIRspacer
#define maxDRspacer options.maxDRspacer
#define minDRrep options.minDRrep
#define maxDRrep options.maxDRrep
#define minATracts options.minATracts
#define minATractSep options.minATractSep
#define maxATractSep options.maxATractSep
#define maxAPRlen options.maxAPRlen
#define minAPRlen options.minAPRlen
#define minZlen options.minZlen
#define minSTR options.minSTR
#define maxSTR options.maxSTR
#define minSTRreps options.minSTRreps
#define minSTRbp options.minSTRbp
#define minCruciformRep options.minCruciformRep
#define maxCruciformSpacer options.maxCruciformSpacer
#define minTriplexYRpercent options.minTriplexYRpercent
#define maxTriplexSpacer options.maxTriplexSpacer
#define maxSlippedSpacer options.maxSlippedSpacer
#define minKVscore options.minKVscore
#define DO_findSTR flags.DO_findSTR
#define DO_findDR flags.DO_findDR
#define DO_findMR flags.DO_findMR
#define DO_findGQ flags.DO_findGQ
#define DO_findIR flags.DO_findIR
#define DO_findZ flags.DO_findZ
#define DO_findAPR flags.DO_findAPR
#define DO_Cruciform flags.DO_Cruciform
#define DO_Triplex flags.DO_Triplex
#define DO_Slipped flags.DO_Slipped
#define DO_KVzdna flags.DO_KVzdna
#define DO_WGET flags.DO_WGET
#define DO_CHMOD flags.DO_CHMOD
#define KEEP_TIME flags.KEEP_TIME
...
#undef minSTRreps
#undef minSTRbp
#undef minCruciformRep
#undef maxCruciformSpacer
#undef minTriplexYRpercent
#undef maxTriplexSpacer
#undef maxSlippedSpacer
#undef minKVscore
#undef DO_findSTR
#undef DO_findDR
#undef DO_findMR
