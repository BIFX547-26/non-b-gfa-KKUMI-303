...
typedef enum {
	GFA_FALSE = 0, GFA_TRUE = 1
} BOOLEAN;

#ifndef FALSE
#define FALSE GFA_FALSE
#endif

#ifndef TRUE
#define TRUE GFA_TRUE
#endif

typedef struct GFAOptions {
	int minGQrep;
	int maxGQspacer;
	int minMRrep;
	int maxMRspacer;
